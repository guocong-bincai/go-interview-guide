...
[![版本](https://img.shields.io/badge/版本-v5.14-blue?style=flat-square)](./docs)
...
> 共 **395** 道高频面试题 ｜ 12 大核心模块 ｜ 按面试优先级排序
...
| 日期 | 版本 | 更新内容 |
|------|------|----------|
| 2026-09-02 | v5.14 | 面试策略模块新增 3 篇：技术深挖应对策略（追问链拆解/GMP map底层/Channel关闭语义/defer陷阱/Go 1.22循环变量修复、被问住时五步法应对流程、面试官角色拆解、三种实战场景模拟）、HR 面试全攻略（离职原因/职业规划/加班接受度/优缺点/薪资期望六大高频必考题高分框架、HR 面三种风格应对指南、Go 工程师专属优势标签与风险标签）、反问环节全攻略（不同轮次差异化策略、绝杀级高分问题清单、Go 工程师专属加分问题、五大禁区避坑指南）

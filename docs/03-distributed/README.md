...
- [🟡] `01-service-discovery/01-service-discovery.md` — 注册中心（Consul/etcd/Nacos）原理与选型
- [🟡] `04-microservices/02-circuit-breaker/02-circuit-breaker.md` — 熔断（Hystrix/Sentinel）、限流算法（令牌桶/漏桶）
- [🟡] `04-service-discovery/03-tracing.md` — 链路追踪（Jaeger/Zipkin）、TraceID 传播、采样策略

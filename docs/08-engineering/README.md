...
- [ ] `01-oom.md` — OOM 排查：heap dump 分析、内存泄漏定位
- [ ] `02-cpu-spike.md` — CPU 飙升排查：pprof、goroutine 死循环
- [ ] `03-deadlock.md` — 死锁排查：数据库死锁、Go 并发死锁
- [ ] `04-high-latency.md` — 接口高延迟排查：链路追踪、GC 停顿、连接池
- [ ] `05-goroutine-leak.md` — goroutine 泄漏：识别、定位、修复模式

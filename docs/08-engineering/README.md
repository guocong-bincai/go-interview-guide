...
- [✅] [告警治理与 On-Call 工程化：告警风暴收敛、分级、SLO 燃烧率、Runbook 闭环](02-troubleshooting/26-01-alert-governance.md)
...
- [✅] [依赖供应链安全：govulncheck 可达性分析、SBOM、go.sum 完整性链](03-leadership/26-01-supply-chain-security.md)
...
- [✅] [Flaky Test 治理：根因五类、testing/synctest、-shuffle/-count、quarantine 策略](04-performance-governance/26-03-flaky-test.md)
- [✅] [可复现构建与二进制瘦身：-trimpath/-s -w/CGO_ENABLED=0/distroless](04-performance-governance/26-02-reproducible-build.md)
...
- [✅] [持续性能分析（Continuous Profiling）：生产常驻采样与故障回溯](06-race-detector/26-01-continuous-profiling.md)
